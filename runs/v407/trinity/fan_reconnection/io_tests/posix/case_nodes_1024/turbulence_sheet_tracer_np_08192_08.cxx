...
begin_initialization {
  ...
  double taui    = 1500/wpe_wce; // simulation wci's to run
  ...
  double Lx    = 800.0*di;    // size of box in x dimension
  double Ly    = 100.0*di;    // size of box in y dimension
  ...
  int fields_interval      = 1*interval;
  int ehydro_interval      = 1*interval;
  int Hhydro_interval      = 1*interval;
  // int fields_interval      = 10*interval;
  // int ehydro_interval      = 10*interval;
  // int Hhydro_interval      = 10*interval;
  int eparticle_interval   = 100000*interval;
  int Hparticle_interval   = 100000*interval;
...
//			  topology_x, topology_y, topology_z); // Topology
 ...
 // ***** Set Field Boundary Conditions *****
  ...
  species_t *electronTop = define_species("electronTop",-ec/me,1.*Ne/nproc(),-1,electron_sort_interval,0);
  species_t *electronBot = define_species("electronBot",-ec/me,1.*Ne/nproc(),-1,electron_sort_interval,0);
  species_t *ionTop = define_species("ionTop", ec/mi,1.*Ne/nproc(),-1,ion_sort_interval,0);
  species_t *ionBot = define_species("ionBot", ec/mi,1.*Ne/nproc(),-1,ion_sort_interval,0);
