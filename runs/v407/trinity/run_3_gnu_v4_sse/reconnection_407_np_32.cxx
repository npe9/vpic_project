...
begin_initialization {
  ...
  int eparticle_interval = 20*interval;
  int Hparticle_interval = 20*interval;
  int quota_check_interval     = 100;

  //  Determine which domains are along the boundaries - Use macro from grid/partition.c
