...
// Set NUM_TURNSTILES to be the desired number of simultaneous writes.
...
begin_initialization
{
  ...
  double topology_x = REPLACE_topology_x;                      // Number of domains in x, y, and z
  double topology_y = REPLACE_topology_y*REPLACE_topology_y_scale; 
  ...
  sim_log( "Finished loading particles" );
   ...
   /*--------------------------------------------------------------------------
     ...
     *------------------------------------------------------------------------*/
        ...
        sim_log ( "Fields output format = REPLACE_field_io_format" );

        global->hedParams.format = REPLACE_field_io_format;

        sim_log ( "Electron species output format = REPLACE_field_io_format" );

        global->hHdParams.format = REPLACE_field_io_format;

        sim_log ( "Ion species output format = REPLACE_field_io_format" );
